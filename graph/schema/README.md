...
`graph`. Do not edit the generated file by hand.
...
Then run `go test ./graph/...`. The schema test regenerates in memory
and fails if the committed bytes are stale. It also compiles the document as
JSON Schema Draft 2020-12.

A host may consume this committed document to generate an HTTP schema or client.
Frontends should use a generated host surface instead of copying graph DTOs by
hand.
